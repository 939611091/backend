                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">编辑天气</h3>&nbsp&nbsp&nbsp
                            <h3 class="box-title">${msgError}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="${contextPath}/static/weather/edit.do" method="post" id="edit_weather" >
                            ...
                            <div class="box-body">
                                <div class="form-group" id="weatherName">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"  placeholder="天气名" name="name" value="${weather.name }">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
