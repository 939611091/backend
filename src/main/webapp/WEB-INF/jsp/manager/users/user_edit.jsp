                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">编辑用户</h3>&nbsp&nbsp&nbsp
                            <h3 class="box-title">${msgError}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="${contextPath}/users/user/edit.do" method="post" id="edit_user" >
                            <input type="hidden" name="id" value="${user.id }" />
                            <div class="box-body">
                                <div class="form-group" id="nickname">
                                    <label  class="col-sm-2 control-label">昵称</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"  placeholder="昵称" name="nickname" value="${user.nickname }">
                                    </div>
                                </div>
                                <div class="form-group" id="avatar">
                                    <label  class="col-sm-2 control-label">头像地址</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"  placeholder="头像地址" name="avatar" value="${user.avatar }">
                                    </div>
                                </div>
