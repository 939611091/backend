            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="${contextPath}/admin/edit.do" method="post" id="edit_admin" >
                            <input type="hidden" name="adminid" value="${admin.adminid }" />
                            <div class="box-body">
                                <div class="form-group" id="nickname">
                                    <label  class="col-sm-2 control-label">用户名</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"  placeholder="用户名" name="username" value="${admin.username }">
                                    </div>
                                </div>
